...
RSpec.describe Blackjack do
  ...
  describe "setting results" do
    ...
    it "sets the correct results when dealer busts" do
      #Player cards
      card1 = Card.new("Clubs", "10")
      card2 = Card.new("Hearts", "10")
      card3 = Card.new("Diamonds", "Ace")
    ...
    it "sets the correct results when there is a tie" do
      ...
      @blackjack.hit # Player hits and gets 21
      @blackjack.stand # Player stands
      @blackjack.hit # Dealer hits and gets 21 and it's a tie

      expect(@blackjack.set_results).to eq("It's a tie!")
    end

    it "sets the correct results when player wins" do
      #Player cards
      card1 = Card.new("Clubs", "10")
      card2 = Card.new("Hearts", "10")
      card3 = Card.new("Diamonds", "Ace")
      ...
      @blackjack.deck.replace_with(new_deck)
      @blackjack.deal
      @blackjack.hit # Player hits and gets 21, player wins
      @blackjack.stand # Player stands
    ...
    it "sets the correct results when dealer wins" do
      #Player cards
      card1 = Card.new("Clubs", "10")
      ...
      @blackjack.deck.replace_with(new_deck)
      @blackjack.deal
      @blackjack.hit # Player hits and gets 20, player loses
      @blackjack.stand # Player stands
